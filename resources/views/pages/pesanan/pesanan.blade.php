                                ...
                                <td>
                                    ...
                                    @elseif (auth()->user()->role == 2)
                                        <select class="form-control" name="update_status" id="update_status"
                                            ...
                                            <option value="0"
                                                {{ $item['pesanan_user_pelanggan']['status_pesanan'] == 0 && $item['pesanan_user_pelanggan']['status_pesanan'] != null ? 'selected' : '' }}>
                                                DITOLAK</option>
                                            <option value="1"
                                                {{ $item['pesanan_user_pelanggan']['status_pesanan'] == 1 ? 'selected' : '' }}>
                                                DIPROSES</option>
                                            <option value="2"
                                                {{ $item['pesanan_user_pelanggan']['status_pesanan'] == 2 ? 'selected' : '' }}>
                                                DIKIRIM</option>
                                        </select>
                                    @endif
                                </td>
