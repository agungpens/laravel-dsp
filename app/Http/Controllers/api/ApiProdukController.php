...
class ApiProdukController extends Controller
{
    ...
    public function findData(Request $request)
    {
        ...
        try {
            $produk_data = Produk::with('JenisProduk')->where('barcode', $request['barcode'])->first();
            if (!$produk_data) {
                $result['message'] = "Data tidak ditemukan / Belum di masukan ke server";
                $result['is_valid'] = false;
                return response()->json($result);
            }
            $result['data'] = $produk_data;
